 ...
 * 五角大楼  右边
 */
public class CityWa2a extends CivilBuilding{

	public CityWa2a(CenterPoint centerPoint,SceneType sceneType,UnitColor unitColor) {
		super(sceneType,ConstConfig.CityWa2a);
