...
public class PalFileReader {
    ...
    static {
        palPath = PalFileReader.class.getClassLoader().getResource("pal/").getFile();
    }
    ...
    public static int turnBlue(int oriColor) {
        return oriColor >> 16;
    }                                        // 盟军蓝   最深色#0000EC
    
    public static int turnGreen(int oriColor) {
        return oriColor >> 8;
    }                                        // 标准绿   最深色#00EC00
    
    public static int turnYellow(int oriColor) {
        return oriColor | turnGreen(oriColor);
    }                        // 标准黄   最深色#ECEC00  (红+绿)
    
    public static int turnPurple(int oriColor) {
        return oriColor | turnBlue(oriColor);
    }                            // 紫色     最深色#EC00EC  (红+蓝)
    
    public static int turnLightBlue(int oriColor) {
        return turnGreen(oriColor) | turnBlue(oriColor);
    }            // 淡蓝     最深色#00ECEC  (绿+蓝)
    
    public static int turnGray(int oriColor) {
        return oriColor | turnGreen(oriColor) | turnBlue(oriColor);
    }        // 中立灰   最深色#ECECEC  (红+绿+蓝)
    ...
    public static int delAlpha(int oriColor) {
        return oriColor & 0x00FFFFFF;
    }
    
    public static int addAlpha(int oriColor) {
        return oriColor | 0xFF000000;
    }
}
